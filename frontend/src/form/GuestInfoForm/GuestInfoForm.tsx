...
const GuestInfoForm = ({ pricePerNight, hotelId }: Props) => {
  ...
  return (
    <div className="flex flex-col p-4 bg-orange-400 gap-4">
        ...
        <div className="grid grid-cols-1 gap-4 items-center">
          <div>
            <DatePicker
              ...
              className="p-2 min-w-full focus:outline-none"
          ...
          {isLoggedIn ? (
            <button className="bg-primary text-white h-full p-2 font-bold hover:bg-blue-700 text-xl">
              Book now
            </button>
          ) : (
            <button className="bg-primary text-white h-full p-2 font-bold hover:bg-blue-700 text-xl">
